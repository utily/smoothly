...
export class SmoothlyInputRangeDemo {
	render() {
		return (
			<Host>
				<h2>Range</h2>
				<h3>Max 100 step 1 type text</h3>
				<smoothly-input-range min={13.2} max={23} step={0.001} label={"Max 23 step 0.001"} />
				<h3>Max 10 step 1 type text</h3>
				<smoothly-input-range max={10} step={1} label={"Max 100 step 1"} />
				<h3>Max 100 step 1 type percent</h3>
