...
describe("DateRange", () => {
	...
	it("leap year", () => {
		...
		expect(month(today)).toEqual([
			...
			["2024-10-14", "2024-10-15", "2024-10-16", "2024-10-17", "2024-10-18", "2024-10-19", "2024-10-20"],
	...
	it("not leap year", () => {
		...
		expect(month(today)).toEqual([
			...
			["2025-12-22", "2025-12-23", "2025-12-24", "2025-12-25", "2025-12-26", "2025-12-27", "2025-12-28"],
