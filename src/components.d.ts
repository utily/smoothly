...
export interface SmoothlyTableHeaderCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLSmoothlyTableHeaderElement;
}
export interface SmoothlyTableRowCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLSmoothlyTableRowElement;
}
...
declare namespace LocalJSX {
    ...
    interface SmoothlyInput {
        ...
        "minLength"?: number;
        "name"?: string;
        "onSmoothlyChanged"?: (event: SmoothlyInputCustomEvent<{ name: string; value: any }>) => void;
        "pattern"?: RegExp | undefined;
        "placeholder"?: string | undefined;
        "required"?: boolean;
        "showLabel"?: boolean;
    ...
    interface SmoothlyTableExpandableCell {
        "align"?: "left" | "center" | "right";
        "onExpansionLoaded"?: (event: SmoothlyTableExpandableCellCustomEvent<void>) => void;
    ...
    interface SmoothlyTableHeader {
        "name"?: string;
        "onSort"?: (event: SmoothlyTableHeaderCustomEvent<{ property: string; direction: "ascending" | "descending" }>) => void;
        "sortDirection"?: "ascending" | "descending";
    }
    interface SmoothlyTableRow {
        "align"?: "left" | "center" | "right";
        "onExpansionOpen"?: (event: SmoothlyTableRowCustomEvent<HTMLElement>) => void;
        "open"?: boolean;
    }
    interface SmoothlyTrigger {
        "color"?: Color | undefined;
