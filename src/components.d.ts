...
declare namespace LocalJSX {
    ...
    interface SmoothlyFilterFieldAttributes {
        "criteria": string;
    }
    interface SmoothlyFilterInputAttributes {
        "label": string;
        "property": string;
        "placeholder": string;
    }
    interface SmoothlyFilterSelectAttributes {
        "label": string;
        "property": string;
        "menuHeight": `${number}items` | `${number}rem` | `${number}px` | `${number}vh` | undefined;
        "multiple": boolean;
    ...
    interface SmoothlyFilterToggleAttributes {
        "icon": Icon;
        "tooltip": string;
        "not": boolean;
        "flip": boolean;
    ...
    interface IntrinsicElements {
        ...
        "smoothly-filter-field": Omit<SmoothlyFilterField, keyof SmoothlyFilterFieldAttributes> & { [K in keyof SmoothlyFilterField & keyof SmoothlyFilterFieldAttributes]?: SmoothlyFilterField[K] } & { [K in keyof SmoothlyFilterField & keyof SmoothlyFilterFieldAttributes as `attr:${K}`]?: SmoothlyFilterFieldAttributes[K] } & { [K in keyof SmoothlyFilterField & keyof SmoothlyFilterFieldAttributes as `prop:${K}`]?: SmoothlyFilterField[K] };
        "smoothly-filter-input": Omit<SmoothlyFilterInput, keyof SmoothlyFilterInputAttributes> & { [K in keyof SmoothlyFilterInput & keyof SmoothlyFilterInputAttributes]?: SmoothlyFilterInput[K] } & { [K in keyof SmoothlyFilterInput & keyof SmoothlyFilterInputAttributes as `attr:${K}`]?: SmoothlyFilterInputAttributes[K] } & { [K in keyof SmoothlyFilterInput & keyof SmoothlyFilterInputAttributes as `prop:${K}`]?: SmoothlyFilterInput[K] };
        "smoothly-filter-select": Omit<SmoothlyFilterSelect, keyof SmoothlyFilterSelectAttributes> & { [K in keyof SmoothlyFilterSelect & keyof SmoothlyFilterSelectAttributes]?: SmoothlyFilterSelect[K] } & { [K in keyof SmoothlyFilterSelect & keyof SmoothlyFilterSelectAttributes as `attr:${K}`]?: SmoothlyFilterSelectAttributes[K] } & { [K in keyof SmoothlyFilterSelect & keyof SmoothlyFilterSelectAttributes as `prop:${K}`]?: SmoothlyFilterSelect[K] };
        "smoothly-filter-toggle": Omit<SmoothlyFilterToggle, keyof SmoothlyFilterToggleAttributes> & { [K in keyof SmoothlyFilterToggle & keyof SmoothlyFilterToggleAttributes]?: SmoothlyFilterToggle[K] } & { [K in keyof SmoothlyFilterToggle & keyof SmoothlyFilterToggleAttributes as `attr:${K}`]?: SmoothlyFilterToggleAttributes[K] } & { [K in keyof SmoothlyFilterToggle & keyof SmoothlyFilterToggleAttributes as `prop:${K}`]?: SmoothlyFilterToggle[K] };
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "smoothly-filter": LocalJSX.IntrinsicElements["smoothly-filter"] & JSXBase.HTMLAttributes<HTMLSmoothlyFilterElement>;
            "smoothly-filter-field": LocalJSX.IntrinsicElements["smoothly-filter-field"] & JSXBase.HTMLAttributes<HTMLSmoothlyFilterFieldElement>;
            "smoothly-filter-input": LocalJSX.IntrinsicElements["smoothly-filter-input"] & JSXBase.HTMLAttributes<HTMLSmoothlyFilterInputElement>;
            "smoothly-filter-select": LocalJSX.IntrinsicElements["smoothly-filter-select"] & JSXBase.HTMLAttributes<HTMLSmoothlyFilterSelectElement>;
            "smoothly-filter-toggle": LocalJSX.IntrinsicElements["smoothly-filter-toggle"] & JSXBase.HTMLAttributes<HTMLSmoothlyFilterToggleElement>;
            ...
            "smoothly-table-demo-filtered": LocalJSX.IntrinsicElements["smoothly-table-demo-filtered"] & JSXBase.HTMLAttributes<HTMLSmoothlyTableDemoFilteredElement>;
